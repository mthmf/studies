    ...
    public static class LivroPaginadoExtensions 
    {
        public static LivroPaginado ToLivroPaginado(this IQueryable<LivroApi> query, LivroPaginacao paginacao)
        {
            ...
            return new LivroPaginado
            {
                ...
                Anterior = (paginacao.Pagina > 1) ? $"livrs?tamanho={paginacao.Pagina-1}&pagina={paginacao.Tamanho}" : "",
                Proximo = (paginacao.Pagina < totalPaginas) ? $"livrs?tamanho={paginacao.Pagina + 1}&pagina={paginacao.Tamanho}" : "",
